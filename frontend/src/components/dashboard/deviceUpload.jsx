...
const DeviceUploadStepper = ({ open, onClose }) => {
  ...
  const [termsData, setTermsData] = useState({
    ...
    executionDate: new Date().toLocaleDateString('en-GB', { day: '2-digit', month: 'long', year: 'numeric' }),
    partyA: {
      name: "Owen Mutero",
...
const handleInputChange = useCallback((e) => {
  ...
  const generateTermsPDF = async () => {
    ...
    // Title
    addText('Terms and Conditions for Renewable Energy Device Registration', 14, true);
    yPosition += 5;
...
• Party B: ${termsData.partyB.companyName || '[Registered Entity Name]'}, the party providing REDs, supplying documentation, maintaining operational REDs, and cooperating with Party A in the issuance and transfer of RECs.
...
By accessing or using the Platform, you confirm that you have read, understood, and agree to be bound by these T&Cs.`;
    ...
    yPosition += 2;
    addText('These T&Cs govern: (a) the registration of REDs by Party A, (b) the issuance/verification of RECs on the Registry, (c) the transfer of RECs to buyers\' accounts in accordance with Deal Notes or Sales Agreements, and (d) the execution of REC trading and related platform activities.');
    addText('These T&Cs operate in conjunction with Platform policies. In case of inconsistency, the order of precedence is: applicable law, these T&Cs, Platform policies, and any applicable Deal Notes/Sales Agreements.');
    yPosition += 3;
    ...
    const sections = [
      {
        ...
        content: 'Registration, issuance, and transfer shall be conducted in accordance with Registry rules and the I-REC framework. Party A shall undertake reasonable efforts to verify documentation; however, Party A shall not be liable for inaccuracies in information provided by Party B, except for gross negligence or wilful misconduct.'
      },
      {
        title: '5. Fees and Payments',
        content: 'Fees for registration, verification, and issuance shall be borne by the platform operator.'
      },
      {
        title: '6. Compliance and Legal',
        content: 'Both Parties shall comply with applicable laws and regulatory requirements related to REDs, RECs, registration, issuance, transfer, and trading, including anti-fraud, anti-money laundering, counter-terrorist financing, sanctions, data protection, and reporting requirements.'
      },
      {
        title: '7. Representations and Warranties',
        content: 'Each Party represents it has the authority to enter into and perform under these T&Cs, and that performance will comply with all applicable laws and contractual obligations.'
      },
      {
        title: '8. Intellectual Property',
        content: 'Each Party retains its own intellectual property rights. Any licenses granted are non-exclusive, non-transferable, and limited to RED registration, REC issuance, and REC trading purposes.'
      },
      {
        title: '9. Data Protection and Privacy',
        content: 'Each Party shall comply with applicable data protection laws. Personal data shall be handled in accordance with the Platform\'s privacy policy and data processing agreements.'
      },
      {
        title: '10. Limitation of Liability',
        content: 'Neither Party shall be liable for indirect or consequential damages. Direct damages limited to amounts paid in preceding twelve months, except for gross negligence, willful misconduct, or breach of data protection obligations.'
      },
      {
        title: '11. Force Majeure',
        content: 'Neither Party liable for failure or delay due to events beyond reasonable control, provided notice is given and mitigation steps are taken.'
      },
      {
        title: '12. Term and Termination',
        content: 'These T&Cs remain in effect for five years subject to renewal. Either Party may terminate on three months written notice for cause. Termination does not affect accrued rights or ongoing regulatory obligations.'
      },
      {
        title: '13. Data Retention and Recordkeeping',
        content: 'Parties shall maintain records required by applicable law and regulatory authorities.'
      }
    ];
    ...
    addText('Party B grants Party A exclusive right as sole intermediary for sale, marketing, and facilitation of RECs generated from REDs registered under this Agreement.');
    yPosition += 2;
    
    addText('b) Commission and Payment Mechanics', 10, true);
    addText('Party B entitled to commission equal to 30% of net revenue from REC sales. Payment within 5 calendar days following receipt of funds from purchaser.');
    yPosition += 2;
    
    addText('c) Confidentiality and Data', 10, true);
    addText('Each Party shall treat all information exchanged as confidential.');
    yPosition += 2;
    
    addText('d) Termination and Survival', 10, true);
    addText('Exclusivity and commission provisions survive termination to extent necessary for outstanding transactions.');
    yPosition += 3;
    ...
    const finalSections = [
      {
        ...
        content: 'Disputes resolved by commercial arbitration in Harare, Zimbabwe, under CAC rules. Arbitration award final and binding.'
      },
      {
        title: '16. Governing Law and Jurisdiction',
        content: 'These T&Cs governed by laws of Zimbabwe. Courts of Zimbabwe have jurisdiction for non-arbitrable matters.'
      },
      {
        title: '17. Insurance',
        content: 'Parties may maintain appropriate insurance coverage for potential losses.'
      },
      {
        title: '18. Amendments and Updates',
        content: 'Platform Operator may amend T&Cs from time to time. Material amendments communicated in advance.'
      },
      {
        title: '19. Miscellaneous',
        content: 'Parties are independent contractors. Assignment requires prior written consent. Severability and waiver provisions apply.'
      },
      {
        title: '20. Notices',
        content: 'Notices shall be in writing and delivered to addresses specified by each Party.'
      },
      {
        title: '21. Counterparts and Electronic Signatures',
        content: 'T&Cs may be executed in counterparts and by electronic signature.'
      }
    ];
    ...
    if (termsData.partyA.signature) {
      pdf.addImage(termsData.partyA.signature, 'PNG', margin, yPosition, 50, 25);
      yPosition += 30;
    } else {
    ...
    yPosition += 30;
    pdf.setFont(undefined, 'bold');
    pdf.text(`${termsData.partyB.companyName || '[COMPANY NAME]'} ("Party B")`, margin, yPosition);
    yPosition += 15;
    
    if (termsData.partyB.signature) {
      pdf.addImage(termsData.partyB.signature, 'PNG', margin, yPosition, 50, 25);
      yPosition += 30;
    } else {
      pdf.setFont(undefined, 'normal');
      pdf.text('SIGNED: _______________________________', margin, yPosition);
    ...
    yPosition += 8;
    pdf.text(`POSITION: ${termsData.partyB.position || '[Position]'}`, margin, yPosition);
  ...
  const handleSubmitWithTerms = async () => {
    ...
    try {
      ...
      // Download PDF
      pdf.save(`Terms_${termsData.partyB.companyName}_${new Date().toISOString().split('T')[0]}.pdf`);
  ...
  const handleSubmitLater = async () => {
    ...
    try {
      ...
      toast.success("Device uploaded! Unsigned terms document sent to your email.");
      onClose();
    } catch (error) {
      console.error("Error:", error);
      toast.error("Failed to process. Please try again.");
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Select
                    label="Fuel Type"
                    name="fuel_type"
                    options={Object.keys(fuelTechnologyMap).map(fuel => [fuel, fuel])}
                  ...
                  <Select
                    ...
                    options={technologyOptions.map(tech => [tech.value, tech.label])}
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={(e) => handleDecimalChange("capacity", e.target.value, 4, 6)}
          ...
          >
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                ...
                <hr className="my-4" />
                <p className="text-sm text-gray-600 mb-2">Geographical Coordinates</p>
        ...
        return (
          ...
          >
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <div className="flex items-center text-blue-600 mb-4">
                <Zap className="w-5 h-5 mr-2" />
                <h3 className="text-lg font-medium">Grid Connection & Metering</h3>
              </div>
                        ...
                        <div className="flex-1">
                          <div className="flex items-center">
                            <h4 className="font-medium text-gray-900">
                              {window.innerWidth < 640 ? doc.shortLabel : doc.label}
                            </h4>
                            {doc.required && (
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                  <div className="flex items-center text-blue-600 mb-4">
                    ...
                    <h3 className="text-lg font-medium">Terms and Conditions Agreement</h3>
                  </div>
                  
                  {/* Full Terms Content */}
                  <div className="bg-gray-50 rounded-lg p-6 mb-6 max-h-96 overflow-y-auto" ref={termsRef}>
                    ...
                    <div className="text-sm text-gray-700 space-y-4">
                      ...
                      <div>
                        ...
                        <ul className="list-disc ml-5 space-y-2">
                          <li><strong>Party A:</strong> Silver Carbon P/L, the party responsible for registering Renewable Energy Devices/facilities (REDs) and facilitating verification and issuance of Renewable Energy Certificates (RECs) on the REC Registry, under Party A's account.</li>
                          <li><strong>Party B:</strong> {termsData.partyB.companyName || '[Your Company]'}, the party providing REDs, supplying documentation, maintaining operational REDs, and cooperating with Party A in the issuance and transfer of RECs.</li>
                        </ul>
                        <p className="mt-3">
                          Collectively, Party A and Party B shall be referred to as the "Parties" and individually as a "Party".
                        </p>
                      ...
                      {/* Section 1: Definitions */}
                      <div>
                        <h5 className="font-bold text-base mb-2">1. Definitions</h5>
                        <ul className="list-disc ml-5 space-y-1 text-xs">
                          <li><strong>"RED"</strong> means a Renewable Energy Device or facility that generates renewable electricity and qualifies for RECs.</li>
                          <li><strong>"REC"</strong> means Renewable Energy Certificate representing the environmental attributes of electricity generated by a RED.</li>
                          <li><strong>"Registry"</strong> means the REC registries or issuance bodies to which REDs are registered and RECs are issued.</li>
                          <li><strong>"Issuance"</strong> means the process by which RECs are created and recorded on the Registry.</li>
                          <li><strong>"Deal Notes / Sales Agreement"</strong> means the agreement documenting the sale of RECs between a buyer and seller.</li>
                          <li><strong>"Platform"</strong> means the online system operated by the Platform Operator for registration, issuance, trading, and transfers of RECs.</li>
                          <li><strong>"Platform Operator"</strong> means the operator/administrator of the Platform.</li>
                          <li><strong>"Fees"</strong> means the charges payable in connection with registration, issuance, verification, transfer, and platform use.</li>
                          <li><strong>"Party A Account"</strong> means the account under Party A used to interact with the Registry and Platform.</li>
                          <li><strong>"Parties' Confidential Information"</strong> means non-public information exchanged under these T&Cs.</li>
                        </ul>
                      </div>

                      {/* Section 2: Scope of Agreement */}
                      <div>
                        <h5 className="font-bold text-base mb-2">2. Scope of Agreement</h5>
                        <p className="text-xs">
                      ...
                      {/* Section 3: Roles and Duties */}
                      <div>
                        <h5 className="font-bold text-base mb-2">3. Roles and Duties</h5>
                        
                        <h6 className="font-semibold text-sm mt-2 mb-1">3.1 Party A – Registration and Issuance Facilitator</h6>
                        <ul className="list-disc ml-5 space-y-1 text-xs">
                          <li><strong>Verification Facilitation:</strong> Undertake tasks necessary to facilitate the issuance and trading of RECs.</li>
                          <li><strong>REC Issuance and Registry Connectivity:</strong> Ensure timely issuance of RECs and maintain connectivity to the Registry.</li>
                          <li><strong>Transfer of RECs:</strong> Transfer RECs to buyers in accordance with applicable Deal Notes or Sales Agreements.</li>
                          <li><strong>Payment of Fees:</strong> Make payments for registration, verification, and issuance fees.</li>
                          <li><strong>Platform Execution:</strong> Execute platform-related activities to support REC issuance, transfer, and trading.</li>
                        </ul>
                        
                        <h6 className="font-semibold text-sm mt-3 mb-1">3.2 Party B – RED Provider</h6>
                        <ul className="list-disc ml-5 space-y-1 text-xs">
                          <li><strong>Provision of Documentation:</strong> Provide all relevant documents to Party A.</li>
                          <li><strong>Operational RED Availability:</strong> Ensure REDs are available and operational.</li>
                          <li><strong>Notification of RED Non-Performance:</strong> Immediately notify Party A of any RED non-performance.</li>
                          <li><strong>Cooperation and Data Provision:</strong> Provide timely cooperation and data for verification and issuance.</li>
                          <li><strong>Warranty of Ownership and Authority:</strong> Ensure right and authority to bring REDs into the REC program.</li>
                        </ul>
                      </div>

                      {/* Sections 4-13 */}
                      <div>
                        <h5 className="font-bold text-base mb-2">4. Registration, Issuance, and Transfer Mechanics</h5>
                        <p className="text-xs">
                      ...
                      <div>
                        <h5 className="font-bold text-base mb-2">5. Fees and Payments</h5>
                        <p className="text-xs">Fees for registration, verification, and issuance shall be borne by the platform operator.</p>
                      </div>

                      <div>
                        <h5 className="font-bold text-base mb-2">6. Compliance and Legal</h5>
                        <p className="text-xs">
                      ...
                      <div>
                        <h5 className="font-bold text-base mb-2">7. Representations and Warranties</h5>
                        <p className="text-xs">
                      ...
                      <div>
                        <h5 className="font-bold text-base mb-2">8. Intellectual Property</h5>
                        <p className="text-xs">
                      ...
                      <div>
                        <h5 className="font-bold text-base mb-2">9. Data Protection and Privacy</h5>
                        <p className="text-xs">
                      ...
                      <div>
                        <h5 className="font-bold text-base mb-2">10. Limitation of Liability</h5>
                        <p className="text-xs">
                      ...
                      <div>
                        <h5 className="font-bold text-base mb-2">11. Force Majeure</h5>
                        <p className="text-xs">
                      ...
                      <div>
                        <h5 className="font-bold text-base mb-2">12. Term and Termination</h5>
                        <p className="text-xs">
                      ...
                      <div>
                        <h5 className="font-bold text-base mb-2">13. Data Retention and Recordkeeping</h5>
                        <p className="text-xs">
                      ...
                      {/* Section 14: Exclusivity, Sale of RECs, and Commission */}
                      <div>
                        <h5 className="font-bold text-base mb-2">14. Exclusivity, Sale of RECs, and Commission</h5>
                        
                        <h6 className="font-semibold text-sm mt-2 mb-1">a) Exclusivity</h6>
                        <p className="text-xs">
                          Party B grants Party A exclusive right as sole intermediary for sale, marketing, and facilitation of RECs generated from REDs registered under this Agreement. Party B shall not sell or market RECs outside the Platform without Party A's written consent.
                        </p>
                        
                        <h6 className="font-semibold text-sm mt-2 mb-1">b) Commission and Payment Mechanics</h6>
                        <p className="text-xs">
                        ...
                        <h6 className="font-semibold text-sm mt-2 mb-1">c) Confidentiality and Data</h6>
                        <p className="text-xs">
                          Each Party shall treat all information exchanged as confidential.
                        </p>
                        
                        <h6 className="font-semibold text-sm mt-2 mb-1">d) Termination and Survival</h6>
                        <p className="text-xs">
                      ...
                      {/* Sections 15-21 */}
                      <div>
                        <h5 className="font-bold text-base mb-2">15. Dispute Resolution</h5>
                        <p className="text-xs">
                      ...
                      <div>
                        <h5 className="font-bold text-base mb-2">16. Governing Law and Jurisdiction</h5>
                        <p className="text-xs">
                      ...
                      <div>
                        <h5 className="font-bold text-base mb-2">17. Insurance</h5>
                        <p className="text-xs">
                      ...
                      <div>
                        <h5 className="font-bold text-base mb-2">18. Amendments and Updates</h5>
                        <p className="text-xs">
                      ...
                      <div>
                        <h5 className="font-bold text-base mb-2">19. Miscellaneous</h5>
                        <p className="text-xs">
                      ...
                      <div>
                        <h5 className="font-bold text-base mb-2">20. Notices</h5>
                        <p className="text-xs">
                      ...
                      <div>
                        <h5 className="font-bold text-base mb-2">21. Counterparts and Electronic Signatures</h5>
                        <p className="text-xs">
                      ...
                      <div className="mt-6 p-4 bg-blue-100 rounded-lg">
                        <p className="text-center font-semibold text-sm">
                          THUS DONE AND EXECUTED ON THIS {termsData.executionDate}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Party B Information */}
                  <div className="space-y-4">
                    <h4 className="font-semibold text-gray-900">Party B Information</h4>
                    ...
                    <Input
                      ...
                      onChange={(e) => setTermsData(prev => ({
                        ...prev,
                        partyB: { ...prev.partyB, companyName: e.target.value }
                      }))}
                      required
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <Input
                        ...
                        onChange={(e) => setTermsData(prev => ({
                          ...prev,
                          partyB: { ...prev.partyB, position: e.target.value }
                        }))}
                        required
                    ...
                    <div className="space-y-2">
                      ...
                      <div className={`border-2 rounded-lg p-2 bg-white ${errors.termsSignature ? 'border-red-300' : 'border-gray-300'}`}>
                        <SignatureCanvas
                          ref={signaturePadRef}
                          canvasProps={{
                      ...
                      {errors.termsSignature && (
                        <p className="text-xs text-red-600">{errors.termsSignature}</p>
                      )}
                    ...
                    <div className="bg-blue-50 rounded-lg p-3 mt-4">
                      <p className="text-sm text-gray-700">
                        <strong>Execution Date:</strong> THUS DONE AND EXECUTED ON THIS {termsData.executionDate}
                      </p>
                    </div>
                    ...
                    <div className="flex items-start mt-4">
                      ...
                      />
                      <label htmlFor="termsAccept" className="ml-2 text-sm text-gray-700">
                        I have read, understood, and agree to be bound by the Terms and Conditions for Renewable Energy Device Registration
                      </label>
                    </div>
                  </div>
                </div>
  ...
  const renderMobileHeader = () => (
    <div className="bg-white border-b border-gray-200 p-4">
      <div className="flex items-center mb-3">
        {React.createElement(steps[activeStep].icon, { className: "w-5 h-5 mr-2 text-blue-600" })}
        <h2 className="text-lg font-semibold text-gray-900">{steps[activeStep].title}</h2>
      </div>
        ...
        {steps.map((step, index) => (
          <div key={step.id} className="flex items-center">
            ...
            {index < steps.length - 1 && (
              <div className={`w-1 lg:w-2 h-0.5 mx-4 transition-colors ${
                index < activeStep ? 'bg-blue-600' : 'bg-gray-200'
              }`} />
            )}
          </div>
              ...
              {activeStep === steps.length - 1 && showTermsSection ? (
                <div className="flex gap-2">
                  <motion.button
                    ...
                    disabled={!isStepComplete(activeStep) || isSubmitting || submitType === 'sign-now'}
                    className="flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
                ...
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  onClick={activeStep === steps.length - 1 && !showTermsSection ? handleSubmit : handleNext}
                ...
                >
                  {isSubmitting && activeStep === steps.length - 1 && !showTermsSection ? (
                    <Loader2 className="w-4 h-4 mr-2 animate-spin" />
                  ) : activeStep === steps.length - 1 && !showTermsSection ? (
                    <>Proceed to Terms</>
                  ) : (
                  ...
                  {activeStep !== steps.length - 1 && <ArrowRight className="w-4 h-4 ml-2" />}
                </motion.button>
              )}
            </div>
          </div>
