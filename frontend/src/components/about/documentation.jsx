...
const DocumentationPage = () => {
  ...
  const documents = [
    ...
    {
      id: 3,
      title: "ZIM-REC Platform Guide",
      description: "Comprehensive guide to using the ZIM-REC platform",
      category: "Guides",
      dateAdded: "February 18, 2025",
      link: "/ZIM-RECs Platform Guide.pdf",
      fileSize: "2.1 MB",
      fileType: "PDF",
      downloads: 120,
      featured: true,
      tags: ["Platform", "Guide", "User Manual"],
      thumbnailBg: "from-blue-100 to-green-100",
    },
    {
      id: 4,
      title: "ZIMREC - MERITS Overview",
      description: "Overview of the ZIMREC MERITS system and its benefits",
      category: "Reports",
      dateAdded: "February 18, 2025",
      link: "/ZIMREC - MERITS.pdf",
      fileSize: "1.8 MB",
      fileType: "PDF",
      downloads: 95,
      featured: true,
      tags: ["MERITS", "Overview", "Benefits"],
      thumbnailBg: "from-yellow-100 to-orange-100",
    },
  ];
