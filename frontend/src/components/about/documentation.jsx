...
const DocumentationPage = () => {
  ...
  const documents = [
    {
      id: 1,
      title: "Renewable Energy Certificate (RECs) Guide",
      description: "Comprehensive overview of the RECs program in Zimbabwe",
      category: "Guides",
      dateAdded: "March 03, 2025",
      fileSize: "3.4 MB",
      fileType: "PDF",
      downloads: 142,
      featured: true,
      tags: ["RECs", "Overview", "Guidelines"],
      thumbnailBg: "from-blue-200 to-emerald-100",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      description: "Analysis of financial returns from REC certification",
      category: "Reports",
      ...
      thumbnailBg: "from-blue-100 to-purple-100",
    },
    {
      id: 4,
      title: "Technical Requirements Specification",
      description: "Technical specifications for renewable energy installations",
      category: "Technical",
      ...
      thumbnailBg: "from-orange-100 to-yellow-100",
    },
    {
      id: 5,
      title: "Solar Energy Best Practices",
      description: "Best practices for solar energy projects in Zimbabwe",
      category: "Guides",
      dateAdded: "February 05, 2025",
      fileSize: "3.9 MB",
      fileType: "PDF",
      downloads: 118,
      featured: false,
      tags: ["Solar", "Best Practices", "Implementation"],
      thumbnailBg: "from-yellow-100 to-emerald-100",
    },
    {
      id: 6,
      title: "REC Trading Marketplace Guide",
      description: "How to trade RECs on the Zim-REC marketplace",
      category: "Procedures",
      ...
      downloads: 95,
      featured: true,
      tags: ["Trading", "Marketplace", "Guide"],
      thumbnailBg: "from-blue-100 to-indigo-100",
    },
  ];
