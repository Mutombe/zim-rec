...
const About = () => {
  ...
  const benefitItems = [
    { 
      ...
      description: "Generate additional revenue by selling renewable energy certificates, making clean energy investments financially viable." 
    },
    { 
      icon: <Award size={24} />, 
      title: "Sustainability Credentials", 
      description: "Enhance sustainability reports and demonstrate commitment to reducing carbon footprint." 
    },
    { 
      icon: <FileText size={24} />, 
      title: "Regulatory Compliance", 
      description: "Comply with international environmental regulations and achieve carbon neutrality goals." 
    },
    { 
      icon: <Globe size={24} />, 
      title: "Global Market Access", 
      description: "Improve competitiveness in international trade by demonstrating use of renewable energy." 
    }
  ];

  const energyTypes = [
    { icon: <Sun className="text-yellow-500" size={28} />, name: "Solar Energy" },
    { icon: <Wind className="text-blue-500" size={28} />, name: "Wind Power" },
    { icon: <Droplet className="text-blue-400" size={28} />, name: "Hydropower" },
  ...
  const faqItems = [
    {
      ...
      answer: "AICTS and Silver Carbon absorb all application and registration costs. Project owners don't need to pay upfront as costs will be recovered once the RECs are sold."
    },
    {
    ...
    },
    {
      ...
      answer: "Revenue depends on market demand, certificate prices, and trading mechanisms. We facilitate sales to ensure project owners receive maximum financial benefits."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {energyTypes.map((type, index) => (
              ...
              >
                <Paper elevation={0} className="w-16 h-16 rounded-full flex items-center justify-center shadow-md bg-white mb-3">
                  {type.icon}
                </Paper>
          ...
          <Grid container spacing={8} alignItems="center">
            <Grid item xs={12} md={6}>
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Typography variant="overline" className="text-green-600 font-medium mb-2 block">
                  ABOUT ZIM-REC
                </Typography>
                ...
                <Typography variant="body1" className="text-gray-600 mb-6">
                  Zim-REC is a joint initiative by the Africa Institute for Carbon Trading and Sustainability (AICTS) 
                  and Silver Carbon, designed to accelerate Zimbabwe's transition to renewable energy through 
                  transparent certification and trading mechanisms.
                </Typography>
                
                <div className="space-y-4 mb-8">
                  {['Market Transparency', 'Developer Support', 'Corporate Sustainability'].map((item, index) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <Typography variant="body1" className="text-gray-600 max-w-3xl mx-auto">
              ...
              Each REC represents proof that one megawatt-hour (MWh) of electricity has been generated from a 
              renewable energy source and injected into the grid.
            </Typography>
          </motion.div>
                ...
                >
                  <div className="h-full bg-gradient-to-br from-green-600 to-green-700 p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <Typography variant="body1" className="text-green-50 mb-6">
                      The REC system facilitates the tracking, trading, and retirement of renewable energy claims, 
                      ensuring transparency and credibility in sustainability commitments.
                    </Typography>
                    <div className="space-y-3">
                      {[
                        ...
                        <div key={index} className="flex items-center">
                          <Check className="text-green-300 mr-2 flex-shrink-0" size={18} />
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <Typography variant="body1" className="text-gray-600 max-w-3xl mx-auto">
              Renewable Energy Certification provides tangible benefits for energy producers, corporations, and the environment,
              creating value while supporting Zimbabwe's transition to clean energy.
            </Typography>
          </motion.div>
      ...
      <section className="py-12 md:py-20 bg-gradient-to-br from-green-600 to-green-700 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <Typography variant="body1" className="text-green-50 max-w-2xl mx-auto mb-8">
              Join Zimbabwe's renewable energy revolution. Register your project today and start benefiting from 
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <Typography variant="body1" className="text-gray-600 max-w-3xl mx-auto">
              Find answers to common questions about renewable energy certification and the Zim-REC program.
            </Typography>
          </motion.div>
          ...
          <div className="max-w-3xl mx-auto">
            {faqItems.map((item, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Paper elevation={0} className="mb-6 overflow-hidden border border-gray-100 rounded-xl">
                  <div className="p-6">
          ...
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={7}>
              ...
              <Typography variant="body1" className="text-gray-600">
                Take the first step towards clean energy certification and trading.
              </Typography>
            </Grid>
